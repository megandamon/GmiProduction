...
echo "ssh $NED_USER@$MACH mkdir $STN_WORK_DIR"
ssh $NED_USER@$MACH mkdir $STN_WORK_DIR
export outputCode=$?
...
echo "scp ${NED_WORKING_DIR}/labels.nc $NED_USER@$MACH:$STN_WORK_DIR"
scp ${NED_WORKING_DIR}/labels.nc $NED_USER@$MACH:$STN_WORK_DIR
export outputCode=$?
if [ "$outputCode" != "0" ]; then
